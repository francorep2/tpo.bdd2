...
public class HotelServiceImpl implements IHotelService {
    ...
    @Override
    public void addRoomToHotel(UUID hotelId, RoomDTO roomDTO) {
    ...
    @Override
    public void removeRoomFromHotel(UUID hotelId, UUID roomId) {
        Hotel hotel = hotelneo4jRepository.findById(hotelId)
            .orElseThrow(() -> new HotelNotFoundException("Hotel not found"));
    ...
    @Override
    public List<RoomDTO> getAllRoomsByHotelId(UUID hotelId) {
        Hotel hotel = hotelneo4jRepository.findById(hotelId)
            .orElseThrow(() -> new HotelNotFoundException("Hotel not found"));
