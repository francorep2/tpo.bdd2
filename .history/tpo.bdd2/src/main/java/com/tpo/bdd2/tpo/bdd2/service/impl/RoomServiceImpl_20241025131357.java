...
public class RoomServiceImpl implements IRoomService {
    ...
    // Agrega las nuevas amenities a la lista existente
    room.getAmenities().addAll(amenities);

    // Guarda los cambios en la base de datos
    Room updatedRoom = roomRepository.save(room);
    
    // Convierte Room a RoomDTO y retorna el resultado
    ...
    public RoomDTO removeAmenitiesFromRoom(List<String> amenities, Long id) {
        ...
        throw new UnsupportedOperationException("Unimplemented method 'removeAmenitiesFromRoom'");
    }

    @Override
    public RoomDTO updateRoomAmenities(List<String> amenities, Long id) {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'updateRoomAmenities'");
    }
