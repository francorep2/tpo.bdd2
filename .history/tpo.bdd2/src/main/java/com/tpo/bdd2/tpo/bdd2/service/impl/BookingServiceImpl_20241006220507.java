...
public class BookingServiceImpl implements IBookingService{
    ...
    public BookingDTO createBooking(BookingDTO bookingDTO) {
        ...
        newBooking.setClientId(clientOptional.get().getClientId());
        newBooking.setEndDate(bookingDTO.getEndDate());
        newBooking.setStartDate(bookingDTO.getStartDate());
        newBooking.setBookingPrice(bookingDTO.getBookingPrice());
        newBooking.setHotelId(bookingDTO.getHotelId());
        newBooking.setBookingCode("BC-" + bookingDTO.getClientId() + System.currentTimeMillis());

        Booking savedBooking = bookingRepository.save(newBooking);
        log.info("Se creo la reserva " + newBooking.getBookingId());
