    ...
    public HotelDTO updateHotel(Long id, HotelDTO hotelDTO) {
        ...
        if(!hotel.isPresent()){
           throw new HotelNotFoundException("Hotel not found");
            ...
            hotel.get().setAddress(mapper.addressDTOToAddress(hotelDTO.getAddress()));
            hotel.get().setCityAreas(mapper.cityAreasTypesDTOToCityAreasTypes(hotelDTO.getCityAreas()));
            hotel.get().setEmail(hotelDTO.getEmail());
            hotel.get().setPhone(hotelDTO.getPhone());
            hotel.get().setPoi(mapper.poiDTOsToPois(hotelDTO.getPoi()));
            hotel.get().setPrice(hotelDTO.getPrice());
            hotel.get().setRooms(mapper.roomDTOsToRooms(hotelDTO.getRooms()));
    ...
    public void addRoomToHotel(Long hotelId, RoomDTO roomDTO) {
        ...
        if(!hotel.isPresent()){
           throw new HotelNotFoundException("Hotel not found");
            ...
            hotel.get().getRooms().add(mapper.roomDTOToRoom(roomDTO));
        }
    }
    ...
    public void removeRoomFromHotel(Long hotelId, Long roomId) {
        ...
        if(!hotel.isPresent()){
           throw new HotelNotFoundException("Hotel not found");
            ...
            hotel.get().getRooms().removeIf(room -> room.getRoomId().equals(roomId));
        }
    }
