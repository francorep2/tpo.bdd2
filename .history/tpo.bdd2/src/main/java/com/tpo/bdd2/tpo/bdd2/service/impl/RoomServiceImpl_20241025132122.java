...
public class RoomServiceImpl implements IRoomService {
    ...
    public List<RoomDTO> findRoomByDateRange(LocalDate startDate, LocalDate endDate) {
        return roomNeo4jRepository.findRoomByDateRange(startDate, endDate)
            .stream()
            .map(mapper::roomToRoomDTO)
            .collect(Collectors.toList());
    }
    ...
    @Override
    public List<String> getAmenitiesByRoomId(Long id) {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'getAmenitiesByRoomId'");
    }
}
