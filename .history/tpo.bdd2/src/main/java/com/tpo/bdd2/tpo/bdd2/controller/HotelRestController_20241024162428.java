...
public class HotelRestController {
    ...
    @PutMapping("/{hotelId}")
    public HotelDTO updateHotel(@PathVariable UUID id, @RequestBody HotelDTO hotelDTO){
    ...
    public  ResponseEntity<Void> addRoomToHotel(@PathVariable UUID hotelId, @RequestBody RoomDTO roomDTO){
        hotelService.addRoomToHotel(hotelId, roomDTO);
        return ResponseEntity.ok().build();
    }

    @DeleteMapping("/{hotelId}/rooms/{roomId}")
    public ResponseEntity<Void> removeRoomFromHotel(@PathVariable UUID hotelId, @PathVariable UUID roomId){
    ...
    public List<RoomDTO> getAllRoomsByHotelId(@PathVariable UUID hotelId){
